...
import com.fauzanpramulia.fauzanextramovies.widget.ImageFavoriteWidget;
import com.fauzanpramulia.fauzanextramovies.widget.StackRemoteViewFactory;
        ...
        if (ada==1){
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked){
                    ...
                    int[] ids = AppWidgetManager.getInstance(getApplication()).getAppWidgetIds(new ComponentName(getApplication(), ImageFavoriteWidget.class));
                    ImageFavoriteWidget myWidget = new ImageFavoriteWidget();
